...
_C.MODEL.RPN.POST_NMS_TOP_N_TRAIN = 1000
...
_C.MODEL.ROI_HEADS.SCORE_THRESH = 0.5
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "/data/quan/maskrcnn-benchmark-retinanet/maskrcnn_benchmark/output224x224"
